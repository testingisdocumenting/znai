...
public class LocalDiskOnlyPreparationHandler implements DocumentationPreparationHandler {
    @Override
    ...
    public void prepare(String docId, DocumentationPreparationProgress preparationProgress) {
        preparationProgress.reportProgress("done", Collections.emptyMap(), 100);
    }
}
