...
public class DoxygenFullDescription {
    private final List<DocElement> descriptionElements;
    private final ApiParameters apiParameters;
    private final ApiParameters apiTemplateParameters;
    private final String searchText;

    public DoxygenFullDescription(List<DocElement> descriptionElements,
    ...
    public List<DocElement> getDescriptionElements() {
