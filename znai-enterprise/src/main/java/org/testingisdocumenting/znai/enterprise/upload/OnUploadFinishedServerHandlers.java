...
public class OnUploadFinishedServerHandlers {
    ...
    public static void onUploadFinished(ZnaiServerConfig config, String docId, Path destination, String actor) {
        handlers.forEach(h -> h.onUploadFinished(config, docId, destination, actor));
    }
