...
export function snippetsDemo(registry) {
  registry
    ...
    .add("wide with title and anchor", () => (
      <Snippet wide={true} title="snippet title" lang="java" anchorId="wide-code-anchor" snippet={wideCode()} />
    ))
    .add("wide with title collapsible", () => (
      <Snippet wide={true} title="snippet title" lang="java" snippet={wideCode()} collapsed={false} />
    ))
    .add("with linked method calls", () => (
      <Snippet
        wide={true}
        title="snippet title"
        lang="java"
    ...
    .add("horizontal scroll with title and highlight", () => (
      <Snippet wide={false} lang="java" snippet={wideCode()} highlight={2} title="Hello Snippet" />
    ))
    .add("highlight by line idx", () => <Snippet lang="markdown" snippet={markdownCode()} highlight={[0]} />)
    .add("highlight right side background", () => (
      <TwoSidesLayoutRightPart>
        <Snippet lang="java" snippet={wideCode()} highlight={[1]} />
      </TwoSidesLayoutRightPart>
    ))
    ...
    .add("tabs with wide", () => (
      <Tabs {...tabsContent({ label: "wide", wide: true })} elementsLibrary={elementsLibrary} />
    ))
    .add("python code", () => <Snippet lang="python" snippet={pythonCode()} />)
    .add("large java code with javadocs", () => (
      <Snippet lang="java" highlight={[0, 3, 6]} snippet={largeJavaCodeWithJavaDocs()} />
    ))
...
export function snippetsTwoSidesDemo(registry) {
  registry
    .add("code after heading", () => (
      <Page elementsLibrary={elementsLibrary} docMeta={docMeta()} {...twoSidesPage(snippetAfterSection())} />
    ))
...
export function snippetsTwoColumnsDemo(registry) {
  ...
  registry
    .add("before snippet", () => <Section {...commonProps} content={beforeSnippetContent()} />)
    .add("after snippet", () => <Section {...commonProps} content={afterSnippetContent()} />)
    .add("surrounded by text", () => <Section {...commonProps} content={surroundedByTextContent()} />);
