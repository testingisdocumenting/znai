...
export function attentionBlockPresentationDemo(registry: Registry) {
  registry.add("notes without label", createPresentationDemo(createAttentionBlockContent()));
}

export function createAttentionBlockContent() {
  return [
    {
      type: "AttentionBlock",
