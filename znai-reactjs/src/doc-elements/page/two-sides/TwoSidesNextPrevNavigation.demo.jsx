...
import TwoSidesNextPrevNavigation from './TwoSidesNextPrevNavigation'
...
export function twoSidesNextPrevNavigationDemo(registry) {
    registry
        .add('current chapter is the same as the next', () => (
            <TwoSidesNextPrevNavigation currentTocItem={tocItem('Chapter A', 'Page Two')}
        ...
        .add('previous chapter is different than current', () => (
            <TwoSidesNextPrevNavigation prevPageTocItem={tocItem('Chapter A', 'Page Two')}
        ...
        .add('next chapter is different than current', () => (
            <TwoSidesNextPrevNavigation prevPageTocItem={tocItem('Chapter A', 'Page One')}
