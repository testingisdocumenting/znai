...
export function pagesDemo(registry) {
  ...
  registry
    .add("default", () => <Page elementsLibrary={elementsLibrary} docMeta={docMeta()} {...defaultPage} />)
    .add("default with search result", () => (
      <Page
        elementsLibrary={elementsLibrary}
        docMeta={docMeta()}
        searchResultId={{ dirName: "introduction", fileName: "page1", pageSectionId: "stale-documentation" }}
        {...defaultPage}
      />
    ))
    .add("api", () => <Page elementsLibrary={elementsLibrary} docMeta={docMeta()} {...apiPage} />)
    .add("two sides", () => <Page elementsLibrary={elementsLibrary} docMeta={docMeta()} {...twoSidesPageContent()} />)
      ...
      },
      {
        ...
        content: [
          ...
          },
          {
            ...
            paths: ["root.store.book[0].category", "root.store.book[2].category"],
            type: "Json",
            meta: {
              rightSide: true,
            },
                ...
                content: [
                  {
                    ...
                    tokens: [
                      ...
                      {
                        type: "class-name",
                        content: ["InternationalPriceService"],
                      },
                      " ",
                      {
                        type: "keyword",
