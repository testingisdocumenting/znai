...
export function graphVizSvgDemo(registry) {
  ...
  registry
    .add("without colors", () => <GraphVizSvg {...createDiagramWithoutColors("id3")}/>)
    .add("aligned center", () => <GraphVizSvg {...createDiagramWithoutColors("id3")} align={"center"} />)
    .add("aligned right", () => <GraphVizSvg {...createDiagramWithoutColors("id3")} align={"right"} />)
    .add("with cluster and dots", () => <GraphVizSvg {...createDiagramWithDotsAndSubGraphs("id0")} />)
    .add("default colors", () => <GraphVizSvg {...createDiagramWithoutColors("id1")} />)
    .add("multiple colors", () => <GraphVizSvg {...createDiagramWithColors("id2")}/>)
