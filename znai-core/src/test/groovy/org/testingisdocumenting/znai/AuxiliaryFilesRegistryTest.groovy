...
class AuxiliaryFilesRegistryTest {
    ...
    void "maintains dependency between tocitem and auxiliary files"() {
        ...
        def tocItemA = new TocItem("chapter-a", "page-one", "md")
        def tocItemB = new TocItem("chapter-b", "page-two", "md")
        ...
        def auxiliaryFilesA = registry.auxiliaryFilesByTocItem(new TocItem("chapter-a", "page-one", "md"))
        auxiliaryFilesA.path.size().should == 2
        auxiliaryFilesA.path*.toString().sort().should == ['/root/a1', '/root/a2']

        def auxiliaryFilesB = registry.auxiliaryFilesByTocItem(new TocItem("chapter-b", "page-two", "md"))
